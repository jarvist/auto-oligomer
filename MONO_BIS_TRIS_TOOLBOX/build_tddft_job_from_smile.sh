...
i=1
/home/jarvist/smi23d/smi23d/build/smi2sdf -p /home/jarvist/smi23d/smi23d/build/mmxconst.prm -o "${1%.*}.sdf" "${1}" 
...
%Mem=${MEMg}
%nproc=${CPUS}
#p sp guess=read geom=checkpoint scf=tight b3lyp/6-31g* td(singlets,nstates=1)
