...
#Porting to more modern openbabel obgen; let's see what happens...
#obgen -ff UFF "${1}" > "${1%.*}.sdf"
~/bin/mengine -p ~/bin/mmff94.prm -c ~/bin/mmxconst.prm -o "${1%.*}_mengine.sdf" "${1%.*}.sdf"
